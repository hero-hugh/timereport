...
>(({ visible, onCancel, onSave, isSaving }, ref) => {
	return (
		...
		>
			<div
				className={cn(
					'pointer-events-auto flex items-center gap-4 rounded-2xl bg-white dark:bg-gray-900 px-5 py-3 shadow-lg ring-1 ring-black/5 dark:ring-white/10',
			...
			>
				...
				{/* Text */}
				<p className="flex-1 text-sm text-gray-600 dark:text-gray-400 min-w-0">
				...
				<div className="flex shrink-0 items-center gap-2">
					<Button
						variant="outline"
						size="sm"
						className="rounded-lg border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700"
						onClick={onCancel}
						disabled={isSaving}
					>
						Avbryt
